...
import PatientRecordView from '@/app/components/doctor/PatientRecordView';
      ...
      <Router>
        <div className="min-h-screen bg-gray-50">
          <Routes>
            ...
            <Route path="/patient/appointment/:doctorId?" element={<AppointmentBooking />} />
            ...
            <Route path="/doctor/patient/:patientId" element={<PatientRecordView />} />
